...
- (void)setThemeFileName:(NSString *)themeFileName {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:themeFileName ofType:@"plist" inDirectory:@"Data"];
...
- (NSArray *)availableThemes {
    ...
    NSString *documentsPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"Data"];
